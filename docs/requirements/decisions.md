...
| ID | Proposal | Notes |
| --- | --- | --- |
| DEC-006 | Custom test values default to exploratory and block certification eligibility unless an approved override policy says otherwise. | This protects certification integrity while enabling participant experimentation. |
...
| OPEN-003 | Whether custom-value overrides can ever remain certifiable. | Affects result schema, UI, validator, and participant guidance. | Standards + Certification |
