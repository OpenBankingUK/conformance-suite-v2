...
_STANDARDS_ROOT = REPO_ROOT / "conformance" / "standards" / "ob_read_write" / "v3_1_11"
    ...
    assert contract["corrections"] == [
        {
            ...
            "regressionTest": "tests/unit/catalogue/test_v311_parity.py::test_v311_catalogues_match_legacy_operations_and_flags",
